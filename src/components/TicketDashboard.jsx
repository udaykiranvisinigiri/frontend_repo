...
const TicketDashboard = () => {
  ...
  const fetchTickets = async () => {
    try {
      const response = await TicketAPI(user.sessionId);
              ...
              >
                  ...
                  <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                    ...
                    <Box
                      ...
                      onClick={() => {
                        ...
                        navigator.clipboard?.writeText(ticket[0]);
                      }}
                      sx={{
                        cursor: 'pointer',
                ...
                <TableCell>
                  <Chip
                    ...
                    size="small"
                    sx={{
                      backgroundColor: getPriorityColor(ticket[5]),
                      color: '#ffffff',
                      fontWeight: 'bold',
                    }}
                  />
                ...
                <TableCell>
                  <Chip
                    ...
                    size="small"
                    sx={{
                      backgroundColor: getStatusColor(ticket[9]),
                      color: '#ffffff',
                      fontWeight: 'bold',
                    }}
                  />
