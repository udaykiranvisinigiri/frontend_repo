        ...
        <Toolbar sx={{ py: 1, minHeight: '64px !important', width: '100%', px: 3 }}>
          ...
          {user && (
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 0 }}>
              ...
              {(user.role === 'support_engineer' || user.role === 'admin' || user.role === 'support_engineer') && (
                <>
              ...
              {/* Analytics - for Training Manager, Help Desk Analyst, and admin */}
              {(user.role === 'Training Manager' || user.role === 'support_engineer' || user.role === 'admin') && (
                <>
                  <Divider orientation="vertical" flexItem sx={{ mx: 0.5, borderColor: 'rgba(255, 255, 255, 0.2)', height: '24px', alignSelf: 'center' }} />
                  <Button
                    component={RouterLink}
              ...
              {/* Escalation - for Training Manager, Help Desk Analyst, and admin */}
              {(user.role === 'Training Manager' || user.role === 'support_engineer' || user.role === 'admin') && (
                <>
                  <Divider orientation="vertical" flexItem sx={{ mx: 0.5, borderColor: 'rgba(255, 255, 255, 0.2)', height: '24px', alignSelf: 'center' }} />
                  <Button
              ...
              {/* Integration - for Help Desk Analyst and admin */}
              ...
              {/* Model Versioning - for Help Desk Analyst and admin */}
              {(user.role === 'support_engineer' || user.role === 'admin') && (
                <>
                  <Divider orientation="vertical" flexItem sx={{ mx: 0.5, borderColor: 'rgba(255, 255, 255, 0.2)', height: '24px', alignSelf: 'center' }} />
                  <Button
